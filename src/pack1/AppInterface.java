...
public class AppInterface {
    ...
    public void start() {
        ...
        System.out.println("Welcome to the File Retrieval Engine!");
            ...
            switch (command) {
                case "index":
                    if (commandArgs.length == 2) {
                        ...
                        System.out.println("Invalid command format. Please provide dataset path.");
                    }
                    break;
                case "search":
                    if (commandArgs.length == 2) {
                        ...
                        System.out.println("Invalid command format. Please provide search query.");
                    }
                    break;
                case "quit":
                    running = false;
